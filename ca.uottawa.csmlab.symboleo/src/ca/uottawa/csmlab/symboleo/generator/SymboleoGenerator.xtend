        ...
        constructor(«model.parameters.map[Parameter p | p.name].join(', ')») {
          ...
          «FOR variable : model.variables»
            «IF variable.type instanceof RegularType»
              this.«variable.name» = new «variable.type.name»("«variable.name»"«getDefaultController(model,variable)»)
		...
		var String addRule=""
         ...
         if (rule.accessedResource instanceof ResourcePower) {
    			...
    			val Power power = p.resourcePo as Power
    		 	...
    		 	if (power.trigger === null){
    		 	addRule=addRule+"this.aCPolicy.addRulee("+contr.name+", "+rName+", this."+(rl as VariableRef).variable+")\n"
		...
		var String addRule=""
         ...
         if (rule.accessedResource instanceof ResourcePower) {
    			...
    			val Power power = p.resourcePo as Power
    		 	...
    		 	addRule=addRule+"this.aCPolicy.addRulee("+contr.name+", contract."+rName+", contract."+(rl as VariableRef).variable+")\n"
